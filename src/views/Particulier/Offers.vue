        ...
        <table class="min-w-full divide-y-2 divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-2 text-gray-700">CTM</td>
                        ...
                        <td class="whitespace-nowrap px-4 py-2">
                            ...
                            <a href="#" class="inline-block rounded bg-green-600 px-4 py-2 text-xs font-medium text-white mx-2">
                                Accept
                            </a>
                            <a href="#" class="inline-block rounded bg-red-600 px-4 py-2 text-xs font-medium text-white">
                                Refuse
                            </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-2 text-gray-700">Farasha</td>
