...
export default {
  ...
  setup() {
    ...
    const equipements = circuit.equipements;
    const checkedBagage = circuit.bagages;
    const motif = circuit.motif;
  ...
  methods: {
    ...
    async confirmTrip() {
      const tripData = {
        triptype: 'Circuit', // You need to set this based on your application logic
