<template>
  <div class="container mx-auto mb-36" id="testamonials">
    ...
    <div class="grid grid-cols-8 gap-6 pt-10">

      <div class="col-span-6 col-start-2 md:col-span-3 md:col-start-2 relative shadow-md p-6">
        <img
          src="../assets/bxs_quote-right.png"
          alt=""
      ...
      <div class="col-span-6 col-start-2 md:col-span-3 relative shadow-md p-6">
        <img
          src="../assets/bxs_quote-right.png"
          alt=""
          class="absolute -top-4 -left-5"
