  ...
  <form novalidate="" action="" class="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
    <div class="grid grid-cols-6 gap-6 col-span-full lg:col-span-3 p-10">
      ...
      <div class="col-span-full py-5">
        <RouterLink class="text-white bg-primary px-6 py-3 rounded-md mr-3" to="/circuit/etape2" @click="submit">Etape Suivante
        </RouterLink>
...
export default{
  setup(){
    ...
    const submit = () => {
      circuit.registerSociete(prenom.value, nom.value, denomination.value, ice.value, email.value, password.value, passwordConfirm.value, isAgree.value)
    }
