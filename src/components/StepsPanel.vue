    ...
    <section class="container mx-auto pt-10" >
        ...
        <div class="grid grid-cols-6 pt-10 gap-3">
            ...
            <div class="col-span-4 col-start-2 md:col-span-2 md:col-start-4 flex flex-col justify-center">
                <h1 class="text-2xl font-semibold text-primary">01. <br /> {{ $t('stepsStep1Title') }} </h1>
                <p>
                    {{ $t('stepsStep1Content') }}
                </p>
            </div>
        ...
        <div class="grid grid-cols-6 pt-10 gap-3">
            <div class="col-span-4 col-start-2 md:col-span-2 md:col-start-2 flex flex-col justify-center">
                <h1 class="text-2xl font-semibold text-primary">02. <br /> {{ $t('stepsStep2Title') }}</h1>
                <p>{{ $t('stepsStep2Content') }}</p>
            </div>
        ...
        <div class="grid grid-cols-6 pt-10 gap-3">
            ...
            <div class="col-span-4 col-start-2 md:col-span-2 md:col-start-4 flex flex-col justify-center">
                <h1 class="text-2xl font-semibold text-primary">03. <br /> {{ $t('stepsStep3Title') }}</h1>
                <p>{{ $t('stepsStep3Content') }}</p>
            </div>
        </div>
    </section>
</div>
